...
$date = date("d/m/Y");
header("Content-Disposition: attachment; filename=Report_Aktivasi_Service".$date.".xls");
			...
			<table height="200px" class="table table-striped table-bordered table-hover font-11" border="1px">
				<thead>
					<tr>
                        ...
                        <th style="text-align:center;vertical-align:middle;background-color:#1ABC9C;color:#F0F0F0;">TANGGAL CLOSING</th>  
				...
				<tbody>
					...
					foreach ($asr as $d)
					{
						...
						$tgl_testing = $d['TGL_AKTIVASI_SERVICE'];
						$tgl_live = $d['TGL_LIVE_ASR'];
