...
$date = date("d/m/Y");
header("Content-Disposition: attachment; filename=Report_Non_Aktif_Routing".$date.".xls");
			...
			<table height="200px" class="table table-striped table-bordered table-hover font-11" border="1px">
				...
				<tbody>
					...
					foreach ($narr as $d)
					{
						...
						$tgl_testing = $d['TGL_NON_AKTIF_ROUTING'];
						$tgl_live = $d['TGL_LIVE_NARR'];
					...
					<tr class="">
						...
						<td style="text-align:center"><?php echo $d['ORIGIN_CODE'] ?></td>
