...
$date = date("d/m/Y");
header("Content-Disposition: attachment; filename=Report_Update_BTBP".$date.".xls");
			...
			<table height="200px" class="table table-striped table-bordered table-hover font-11" border="1px">
				<thead>
					<tr>
                         ...
                         <th style="text-align:center;vertical-align:middle;background-color:#1ABC9C;color:#F0F0F0;">APPROVAL 1</th>
                         <th style="text-align:center;vertical-align:middle;background-color:#1ABC9C;color:#F0F0F0;">TANGGAL APPROVAL 1</th>
                         <th style="text-align:center;vertical-align:middle;background-color:#1ABC9C;color:#F0F0F0;">NOTICE APPROVAL 1</th>
                         <th style="text-align:center;vertical-align:middle;background-color:#1ABC9C;color:#F0F0F0;">PIC APPROVAL 1</th>
                         <th style="text-align:center;vertical-align:middle;background-color:#1ABC9C;color:#F0F0F0;">APPROVAL 2</th>
                         <th style="text-align:center;vertical-align:middle;background-color:#1ABC9C;color:#F0F0F0;">TANGGAL APPROVAL 2</th>
                         <th style="text-align:center;vertical-align:middle;background-color:#1ABC9C;color:#F0F0F0;">NOTICE APPROVAL 2</th>
                         <th style="text-align:center;vertical-align:middle;background-color:#1ABC9C;color:#F0F0F0;">PIC APPROVAL 2</th>
                         ...
                         <th style="text-align:center;vertical-align:middle;background-color:#1ABC9C;color:#F0F0F0;">PIC LIVE</th>
                         <th style="text-align:center;vertical-align:middle;background-color:#1ABC9C;color:#F0F0F0;">NOTICE LIVE</th>  
                         <th style="text-align:center;vertical-align:middle;background-color:#1ABC9C;color:#F0F0F0;">TANGGAL CLOSE</th>
				...
				<tbody>
					...
					foreach ($btbp as $d)
					{
						...
						$tgl_testing = $d['TGL_UPDATE_BTBP'];
						$tgl_live = $d['TGL_LIVE_BTBP'];
						$tgl_close = $d['TGL_CLOSING'];
						...
						if($a == "" && $b == "" && $c == "")
						{
							$status = "OUTSTANDING APPROVAL 1";
						}
						else if($a == "1" && $b == "" && $c == "")
						{
							$status = "OUTSTANDING APPROVAL 2";
						}
						else if($a == "1" && $b == "1" && $c == "")
						{
							$status = "TESTING";
					...
					<tr class="">
		                ...
		                <td style="text-align: center"><?php echo $d['PIC_LIVE'] ?></td>
		                <td style="text-align: center"><?php echo $d['NOTICE_LIVE'] ?></td>
		                <td style="text-align: center"><?php echo $tgl_close ?></td>
