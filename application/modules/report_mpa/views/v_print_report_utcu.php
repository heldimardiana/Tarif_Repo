...
$date = date("d/m/Y");
header("Content-Disposition: attachment; filename=Report_Update_Tarif_Cabang_Utama".$date.".xls");
...
<div class="row-fluid">
	<div class="span12">
		...
		?>
			...
			Report Update Tarif Cabang Utama <br>
			...
			<table height="200px" class="table table-striped table-bordered table-hover font-11" border="1px">
				...
				<tbody>
					...
					foreach ($utcu as $d)
					{
						...
						$tgl_testing = $d['TGL_UPDATE_TARIF_CABANG_UTAMA'];
						$tgl_live = $d['TGL_LIVE_UTCU'];
