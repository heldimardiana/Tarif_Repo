...
$date = date("d/m/Y");
header("Content-Disposition: attachment; filename=Report_Ubah_Zona".$date.".xls");
			...
			<table height="200px" class="table table-striped table-bordered table-hover font-11" border="1px">
				<thead>
					<tr>
                         ...
                         <th style="text-align:center;vertical-align:middle;background-color:#1ABC9C;color:#F0F0F0;">CURRENT ZONA</th>
                         <th style="text-align:center;vertical-align:middle;background-color:#1ABC9C;color:#F0F0F0;">MODIF ZONA</th>
				...
				<tbody>
					...
					foreach ($uzr as $d)
					{
						...
						$tgl_testing = $d['TGL_UBAH_ZONA'];
						$tgl_live = $d['TGL_LIVE_UZR'];
					...
					<tr class="">
		                ...
		                <td style="text-align: center"><?php echo $d['CURRENT_ZONE'] ?></td>
		                <td style="text-align: center"><?php echo $d['MODIF_ZONE'] ?></td>
