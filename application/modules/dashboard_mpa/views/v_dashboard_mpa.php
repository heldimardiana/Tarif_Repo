	...
	<div class="panel panel-border panel-primary">
		...
		<div class="panel-body">
			<div class="row">
					...
					<div class="col-sm-6 col-md-6 col-lg-4">
						<div class="widget-bg-color-icon card-box">
							...
							<div class="text-right">
								...
								<p class="text-muted"><b style="color:#6C7A89;">Approval Update Tarif</b></p>
							</div>
				...
				-->
				<a href="<?php echo site_url('cnt_utcu')?>">
				...
				<a href="<?php echo site_url('utcr')?>" title="Approval Tarif Cabang">
					<div class="col-sm-6 col-md-6 col-lg-3">
						<div class="widget-bg-color-icon card-box">
							<div class="bg-icon bg-icon-pink pull-left">
								<i class="md  md-thumb-up text-pink"></i>
				...
				<a href="<?php echo site_url('ucr')?>" title="Approval Ubah Coding">
					<div class="col-sm-6 col-md-6 col-lg-3">
						<div class="widget-bg-color-icon card-box">
				...
				<a href="<?php echo site_url('uzr')?>" title="Approval Ubah Zona">
					<div class="col-sm-6 col-md-6 col-lg-3">
						<div class="widget-bg-color-icon card-box">
							<div class="bg-icon bg-icon-success pull-left">
								<i class="md  md-thumb-up text-success"></i>
				...
				<a href="<?php echo site_url('narr')?>" title="Approve Non Aktif Routing">
					<div class="col-sm-6 col-md-6 col-lg-3">
						<div class="widget-bg-color-icon card-box">
							<div class="bg-icon bg-icon-success pull-left">
								<i class="md  md-thumb-up text-success"></i>
				...
				<a href="<?php echo site_url('nasr')?>" title="Approve Non Aktif Service">
					<div class="col-sm-6 col-md-6 col-lg-3">
						<div class="widget-bg-color-icon card-box">
							<div class="bg-icon bg-icon-pink pull-left">
								<i class="md  md-thumb-up text-pink"></i>
				...
				<!--
				<a href="<?php echo site_url('psr')?>" title="Approval Penambahan Service">
					<div class="col-sm-6 col-md-6 col-lg-3">
						<div class="widget-bg-color-icon card-box">
							<div class="bg-icon bg-icon-primary pull-left">
								<i class="md md-thumb-up text-primary"></i>
				...
				-->
				<a href="<?php echo site_url('asr')?>" title="Approval Aktif Service non Aktif">
					<div class="col-sm-6 col-md-6 col-lg-3">
						<div class="widget-bg-color-icon card-box">
							<div class="bg-icon bg-icon-primary pull-left">
								<i class="md  md-thumb-up text-primary"></i>
				...
				<a href="<?php echo site_url('utir')?>" title="Approval Update Tarif Intracity">
					<div class="col-sm-6 col-md-6 col-lg-3">
						<div class="widget-bg-color-icon card-box">
							<div class="bg-icon bg-icon-success pull-left">
								<i class="md  md-thumb-up text-success"></i>
				...
				<a href="<?php echo site_url('btbp_dash')?>" title="Approval Update BTBP">
					<div class="col-sm-6 col-md-6 col-lg-3">
						<div class="widget-bg-color-icon card-box">
							<div class="bg-icon bg-icon-success pull-left">
								<i class="md  md-thumb-up text-success"></i>
							...
							<div class="text-right">
								<?php foreach($btbp as $ut) { ?>
								<h3 class="text-dark"><b data-plugin="counterup"><?php echo $ut['NO_REQ'] ?></b></h3>
								<?php } ?>
								<p class="text-muted"><b style="color:#6C7A89;font-size: 12px;">Approval Update BTBP</b></p>
							</div>
							<div class="clearfix"></div>
						</div>
					</div>
