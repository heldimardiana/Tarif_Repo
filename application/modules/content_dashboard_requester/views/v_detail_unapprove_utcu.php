<div>
    <a href="<?php echo site_url('unapprove_utcu_req')?>">
...
<?php foreach($detail as $jokowi){?>
    <form action="<?php echo site_url().'content_dashboard_requester/c_content_dashboard_requester/export_detail'?>" method="post">
