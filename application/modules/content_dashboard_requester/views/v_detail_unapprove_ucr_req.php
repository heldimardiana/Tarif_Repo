<div>
    <a href="<?php echo site_url('unapprove_ucr_req')?>">
...
<div class="row">
	<div class="col-sm-12">
		<div class="card-box">
			<div class="row">
				<form class="form-horizontal" role="form" method="post" action="<?php echo site_url('save_detail_ubah_coding_regional');?>">
...
<div>
  <?php foreach($detail as $jokowi){?>
    <form action="<?php echo site_url().'content_dashboard_requester/c_content_dashboard_requester/export_detail_ucr'?>" method="post" enctype="multipart/form-data">
...
<?php foreach($status as $s) { 
    ...
    $status_testing     = $s['STATUS_TESTING'];

    ?>
    <?php if($status_regional == "2" && $status_mpa == "" && $status_testing == ""){ ?>
                            ...
                            <div class="table-responsive" style="padding: 0 auto">
                                <table class="table table-bordered table-hover table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                    <tr>
                                        <td class="text-center" style="background-color: #f05050;color:white;font-size: 11px;font-family:"Times New Rowman,Times";"><?php echo $ut['STATUS_REQUEST'] ?></td>
                                        <td class="text-center" style="font-size: 11px;font-family:"Times New Rowman,Times";"><?php echo $ut['PIC_REGIONAL'] ?></td>
                                        <td class="text-center" style="background-color: #f05050;color:white;font-size: 11px;font-family:"Times New Rowman,Times";"><?php echo $date ?></td>
    ...
    <?php } else if($status_regional == "1" && $status_mpa == "2" && $status_testing == ""){ ?>
        <div class="col-lg-12" id="dua">
    ...
    <?php } else if($status_regional == "1" && $status_mpa == "1" && $status_testing == "2"){ ?>
    <div class="col-lg-12" id="dua">
            <div class="panel panel-border panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title" align="center">Notice Regional</h3>
