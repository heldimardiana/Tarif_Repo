...
<div>
  <form action="<?php echo site_url().'report_requester/c_report_requester/print_report_narr'?>" method="post">
		...
		<div class="card-box table-responsive" style="padding: 0 auto">
			<table id="mydata" class="table table-bordered table-hover table-responsive">
              ...
              <?php 
                    ...
                    $tgl_test = date('d-m-Y',strtotime($ut['TGL_NON_AKTIF_ROUTING']));
                    ...
                    $tgl_liv = date('d-m-Y',strtotime($ut['TGL_LIVE_NARR']));
              ...
              <tr id="data_row_<?php echo$n; ?>">
                ...
                <td class="text-center" style="font-size: 11px;font-family:"Times New Rowman,Times";"><?php echo $ut['ORIGIN_CODE'] ?></td>
