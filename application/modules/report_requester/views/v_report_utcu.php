...
<div>
	<form action="<?php echo site_url().'report_requester/c_report_requester/print_report_utcu'?>" method="post">
                ...
                <tbody>
                	<?php 
                   	...
                   	foreach ($utcu as $ut){ 
                   		...
                   		$tgl_update_tari  = date('d-m-Y',strtotime($ut['TGL_UPDATE_TARIF_CABANG_UTAMA']));
                   		...
                   		$tgl_liv  = date('d-m-Y',strtotime($ut['TGL_LIVE_UTCU']));
