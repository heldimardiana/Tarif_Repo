...
<div>
  <form action="<?php echo site_url().'report_requester/c_report_requester/print_report_asr'?>" method="post">
		...
		<div class="card-box table-responsive" style="padding: 0 auto">
			<table id="mydata" class="table table-bordered table-hover table-responsive">
              ...
              <?php 
                    ...
                    $tgl_test = date('d-m-Y',strtotime($ut['TGL_AKTIVASI_SERVICE']));
                    ...
                    $tgl_liv = date('d-m-Y',strtotime($ut['TGL_LIVE_ASR']));
