...
<script type="text/javascript">
    $( function() {    
        var data_pegi = "<?php echo site_url().'update_tarif_cabang_requester/c_update_tarif_cabang_requester/get_cabang';?>";
    $( "#auto_ca" ).autocomplete({
      source: data_pegi,
      minLength: 4,
...
<div class="row">
	<div class="col-sm-12">
		<div class="card-box">
			<div class="row">
				<form class="form-horizontal" role="form" method="post" action="<?php echo site_url('save_update_tarif_cabang_requester');?>" enctype="multipart/form-data">
					<div class="col-md-5">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" value="<?php echo $cu['BRANCH_CITY']?> - <?php echo $cu['BRANCH_DESC']?>" class="form-control" readonly >
                                <input type="hidden" value="<?php echo $cu['BRANCH_CODE']?>" class="form-control" name="cabang_utama">
                            </div>
                        </div>
                        <?php } ?>
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                  <input type="text" class="form-control" required title="Input Cabang" id="auto_ca" onkeyup="loadings()" onchange="getDestination();" maxlength="8">
                                  <input type="hidden" id="cabang" class="form-control" required name="cabang" title="Input Cabang">
                                  
                                  <span class="input-group-btn">
                                    <button class="btn btn-success" type="button" title="Cek Sub" onclick="getChild();loadings();Aktiv_lagi()"><i class="fa fa-search"></i></button>
                                  </span>
                                </div><!-- /input-group -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" required  id="auto_des" onkeyup="loading()" maxlength="8" disabled>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <select class="form-control" name="perubahan" required title="Pilih Perubahan yang akan Dilakukan" onchange="getService()" disabled id="perubahan">
					...
					<div class="col-md-5">
	                    ...
	                    <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" id="date_from" required class="form-control" name="tgl_update_tarif" title="Isi Tanggal Update Tarif">
                            </div>
                        </div> 
                        -->
					</div>
