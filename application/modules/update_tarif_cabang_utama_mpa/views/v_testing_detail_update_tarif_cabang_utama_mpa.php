...
<div class="row">
  <div class="col-sm-12">
    <div class="card-box">
      <div class="row">
        <form class="form-horizontal" role="form" method="post" action="<?php echo site_url('save_testing_detail_update_tarif_cabang_utama_mpa');?>" enctype="multipart/form-data">
          ...
          <div class="col-md-5">    
            ...
            <div class="form-group" id="tut" style="display: none;">
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" class="form-control" id="date_1" name="tgl_live_utcu" onkeyup="hapus()">
                </div>
            </div>
