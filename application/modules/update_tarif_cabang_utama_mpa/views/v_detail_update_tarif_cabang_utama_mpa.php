...
<div class="row">
  <div class="col-sm-12">
    <div class="card-box">
      <div class="row">
        <form class="form-horizontal" role="form" method="post" action="<?php echo site_url('save_detail_update_tarif_cabang_utama_mpa');?>" enctype="multipart/form-data">
          ...
          <div class="col-md-5">    
            ...
            <div class="form-group" id="tut" style="display: none;">
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" class="form-control" id="tanggal" name="tgl_update_tarif_cabang_utama" onkeyup="hapus()">
                </div>
            </div>  
          </div>
          ...
          <div class="col-md-2">
            <button type="submit" class="btn btn-primary waves-effect waves-light" title="Save Process" onclick="return confirm('Yakin Untuk Melakukan Save Proses?')">Save</button>
                        <a href="<?php echo site_url('update_tarif_cabang_utama_mpa')?>">
...
<?php foreach($detail as $jokowi){?>
  <form action="<?php echo site_url().'update_tarif_cabang_utama_mpa/c_update_tarif_cabang_utama_mpa/export_detail'?>" method="post">
