		...
		<div class="card-box table-responsive" style="padding: 0 auto">
			<table id="mydata" class="table table-bordered table-hover table-responsive">
                ...
                <tbody>
                    ...
                    $tgl_ubah_z = date('d-m-Y',strtotime($uc['TGL_UBAH_ZONA']));
                    if($tgl_ubah_z == '01-01-1970' || $tgl_ubah_z == '01/01/1970' || $tgl_ubah_z == '')
                    {
                        $tgl_ubah_zona = '';
                    }
                    else
                    {
                         $tgl_ubah_zona = $tgl_ubah_z;
                    }
                ...
                <tr id="data_row_<?php echo$n; ?>">
                    ...
                    <td class="text-center" style="font-size: 11px;font-family:"Times New Rowman,Times";"><?php echo $tgl_ubah_zona ?></td>
	                <?php $session = $uc['SESSION_REQUEST'] ?>
	                <td class="text-center">
	                	<a href="<?php echo site_url().'ubah_zona_mpa/c_ubah_zona_mpa/detail_ubah_zona_mpa/'.$session?>">
                ...
                <tr id="data_row_<?php echo$n; ?>">
                    ...
                    <?php $session = $uc['SESSION_REQUEST'] ?>
                    <td class="text-center">
                        <a href="<?php echo site_url().'ubah_zona_mpa/c_ubah_zona_mpa/testing_detail_ubah_zona_mpa/'.$session?>">
                            <button type="button" class="btn btn-primary btn-xs" title="Detail">Detail</button>
                        </a>
                    </td>
                </tr>
