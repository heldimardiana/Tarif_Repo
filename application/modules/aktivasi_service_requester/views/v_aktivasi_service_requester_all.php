...
<script type="text/javascript">
    $( function() {    
        var data_peg = "<?php echo site_url().'aktivasi_service_requester/c_aktivasi_service_requester/get_branch';?>";
...
<script type="text/javascript">
    function getOrigin(){
        ...
        var data_ori = "<?php echo site_url().'aktivasi_service_requester/c_aktivasi_service_requester/get_origin';?>?branch=" + branch;
        $( function() {
...
<script type="text/javascript">
    function getDestination(){
        ...
        var data_des = "<?php echo site_url().'aktivasi_service_requester/c_aktivasi_service_requester/get_destination_all';?>?cu=" + origin;
...
<script type="text/javascript">
    function getService(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('aktivasi_service_requester/c_aktivasi_service_requester/get_service_all')?>?params="+gab,
            dataType: "json",
            data: ddest,
...
<div class="col-lg-5">
	<div class="card-box"> 
		<form action="<?php echo site_url('save_aktivasi_service_requester_all');?>" method="post">
