					...
					<div class="col-md-5">    
                        ...
                        <div class="form-group" id="tut" style="display: none;">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" required value="0000-00-00"  class="form-control" id="date_1" name="tgl_live_btbp" onkeyup="hapus()">
                            </div>
                        </div>
                        <div class="form-group" id="tuts" style="display: none;">
                            ...
                            <div class="col-md-8">
                                <!-- Untuk Testing Id before = 'date_1'  -->
                                <input type="text" required value="0000-00-00" class="form-control" id="date_2" name="tgl_close" onkeyup="hapuss()">
                            </div>
                        </div>
					</div>
