				...
				<form class="form-horizontal" role="form" method="post" action="<?php echo site_url('save_btbp_level_3');?>" enctype="multipart/form-data">
					...
					<div class="col-md-5">    
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <select class="form-control" title="Pilih Status" required name="status" onChange="Getstatus(this)">
                        ...
                        <div class="form-group" id="tut" style="display: none;">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" required value="0000-00-00"  class="form-control" id="tanggal" name="tgl_update_btbp" onkeyup="hapus()">
                            </div>
                        </div>
					</div>
