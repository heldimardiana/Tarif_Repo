...
<script type="text/javascript">
    $( function() {    
        var data_peg = "<?php echo site_url().'non_aktif_routing_requester/c_non_aktif_routing_requester/get_cabang_utama';?>";
...
<script type="text/javascript">
    function destina(){
        ...
        var data_dest = "<?php echo site_url().'non_aktif_routing_requester/c_non_aktif_routing_requester/get_destination_all';?>?cul=" + cabang;
        $( function() {
	...
	<div class="card-box"> 
		<form action="<?php echo site_url('save_non_aktif_routing_requester');?>" method="post">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="auto_cu" required onchange="myFunction()" maxlength="3" onkeyup="heldi();">
				<input type="hidden" class="form-control" name="cabang_utama" id="cabang_utama" required>
			</div>
      ...
      <!--
			<div class="form-group">
				...
				<input type="text" class="form-control" required id="auto_des" onkeyup="loading()">
				<img src="<?php echo base_url();?>assets/images/loading.gif" width="60" style="display:none;" id="gambar2"></img>
				<input type="hidden" class="form-control" name="destination" required id="destination">
			</div>
      -->
      <label for="emailAddress">Destination *</label>
      <div class="input-group m-t-10 form-group">
          <input type="text" class="form-control" required id="auto_des" onkeyup="loading()" maxlength="8">
      ...
      <div class="form-group">
          ...
          <input type="text" id="date_thru" name="tgl_non_aktif_routing" parsley-trigger="change" class="form-control" title="Input Tanggal Non Aktif Routing">
      </div>
      -->
