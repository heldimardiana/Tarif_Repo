<div>
    <a href="<?php echo site_url('utir_reg')?>">
...
<div>
  <?php foreach($detail as $jokowi){?>
    <form action="<?php echo site_url().'content_dashboard_regional/c_content_dashboard_regional/export_detail_utir'?>" method="post" enctype="multipart/form-data">
