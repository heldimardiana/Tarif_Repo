		...
		<div class="card-box table-responsive" style="padding: 0 auto">
			<table id="mydata" class="table table-bordered table-hover table-responsive">
                ...
                <tr id="data_row_<?php echo$n; ?>">
	                ...
	                <td class="text-center">
	                	<a href="<?php echo site_url().'content_dashboard_regional/c_content_dashboard_regional/detail_narr_out/'.$session?>">
		       	...
		       	<tr id="data_row_<?php echo$n; ?>">
	                ...
	                <?php $session = $uc['SESSION_REQUEST'] ?>
	                <td class="text-center">
	                	<a href="<?php echo site_url().'content_dashboard_regional/c_content_dashboard_regional/testing_detail_narr/'.$session?>">
	                		<button type="button" class="btn btn-primary btn-xs" title="Lihat Detail">Detail</button>
	                	</a>
	                </td>
		        </tr>
		        ...
		        <tr id="data_row_<?php echo$n; ?>">
	                ...
	                <?php $session = $uc['SESSION_REQUEST'] ?>
	                <td class="text-center">
	                	<a href="<?php echo site_url().'content_dashboard_regional/c_content_dashboard_regional/detail_narr/'.$session?>">
	                		<button type="button" class="btn btn-primary btn-xs" title="Lihat Detail">Detail</button>
	                	</a>
	                </td>
		        </tr>
		        ...
		        <tr id="data_row_<?php echo$n; ?>">
	                ...
	                <?php $session = $uc['SESSION_REQUEST'] ?>
	                <td class="text-center">
	                	<a href="<?php echo site_url().'content_dashboard_regional/c_content_dashboard_regional/detail_narr_un/'.$session?>">
	                		<button type="button" class="btn btn-primary btn-xs" title="Lihat Detail">Detail</button>
	                	</a>
	                </td>
		        </tr>
		        ...
		        <tr id="data_row_<?php echo$n; ?>">
	                ...
	                <?php $session = $uc['SESSION_REQUEST'] ?>
	                <td class="text-center">
	                	<a href="<?php echo site_url().'content_dashboard_regional/c_content_dashboard_regional/detail_narr_un2/'.$session?>">
	                		<button type="button" class="btn btn-primary btn-xs" title="Lihat Detail">Detail</button>
	                	</a>
	                </td>
		        </tr>
