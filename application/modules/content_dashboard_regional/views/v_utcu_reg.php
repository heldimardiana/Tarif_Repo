		...
		<div class="card-box table-responsive" style="padding: 0 auto">
			<table id="mydata" class="table table-bordered table-hover table-responsive">
                ...
                <tr id="data_row_<?php echo$n; ?>">
	                ...
	                <td class="text-center">
	                	<a href="<?php echo site_url().'content_dashboard_regional/c_content_dashboard_regional/detail_utcu_reg_out/'.$session ?>">
		        ...
		        <tr id="data_row_<?php echo$n; ?>">
	                ...
	                <?php $session = $ut['SESSION_REQUEST'] ?>
	                <td class="text-center">
	                	<a href="<?php echo site_url().'content_dashboard_regional/c_content_dashboard_regional/detail_testing_utcu/'.$session ?>">
	                		<button type="button" class="btn btn-primary btn-xs" title="Lihat Detail">Detail</button>
	                	</a>
	                </td>
		        ...
		        <tr id="data_row_<?php echo$n; ?>">
	                ...
	                <?php $session = $ut['SESSION_REQUEST'] ?>
	                <td class="text-center">
	                	<a href="<?php echo site_url().'content_dashboard_regional/c_content_dashboard_regional/detail_utcu_reg/'.$session ?>">
	                		<button type="button" class="btn btn-primary btn-xs" title="Lihat Detail">Detail</button>
	                	</a>
	                </td>
		        ...
		        <tr id="data_row_<?php echo$n; ?>">
	                ...
	                <?php $session = $ut['SESSION_REQUEST'] ?>
	                <td class="text-center">
	                	<a href="<?php echo site_url().'content_dashboard_regional/c_content_dashboard_regional/detail_utcu_reg_un/'.$session ?>">
	                		<button type="button" class="btn btn-primary btn-xs" title="Lihat Detail">Detail</button>
	                	</a>
	                </td>
		        ...
		        <tr id="data_row_<?php echo$n; ?>">
	                ...
	                <?php $session = $ut['SESSION_REQUEST'] ?>
	                <td class="text-center">
	                	<a href="<?php echo site_url().'content_dashboard_regional/c_content_dashboard_regional/detail_utcu_reg_un2/'.$session ?>">
	                		<button type="button" class="btn btn-primary btn-xs" title="Lihat Detail">Detail</button>
	                	</a>
	                </td>
