        ...
        <div class="card-box table-responsive" style="padding: 0 auto">
            <table id="mydata" class="table table-bordered table-hover table-responsive">
                ...
                <tr id="data_row_<?php echo$n; ?>">
                    ...
                    <td class="text-center">
                        <a href="<?php echo site_url().'content_dashboard_mpa/c_content_dashboard_mpa/detail_nasr/'.$session ?>">
...
<div class="row" id="satu">
	<div class="col-sm-12">
		<div class="card-box">
			<div class="row">
				<form class="form-horizontal" role="form" method="post" action="<?php echo site_url('save_detail_non_aktif_service_mpa');?>" enctype="multipart/form-data">
                        ...
                        <table class="table table-bordered table-hover table-responsive">
                            ...
                            <tbody>
                                ...
                                foreach ($mpa as $ut){ 
                                    ...
                                    $tgl_live_nasr = date('d-m-Y',strtotime($ut['TGL_LIVE_NASR']));
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="background-color: #09C2FF;color:white;font-size: 11px;font-family:"Times New Rowman,Times";"><?php echo $tgl_live_nasr ?></td>
