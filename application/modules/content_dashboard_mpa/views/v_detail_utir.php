        ...
        <div class="card-box table-responsive" style="padding: 0 auto">
            <table id="mydata" class="table table-bordered table-hover table-responsive">
                ...
                <tr id="data_row_<?php echo$n; ?>">
                    ...
                    <td class="text-center">
                        <a href="<?php echo site_url().'content_dashboard_mpa/c_content_dashboard_mpa/detail_utir/'.$session?>">
...
<div class="row" id="satu">
	<div class="col-sm-12">
		<div class="card-box">
			<div class="row">
				<form class="form-horizontal" role="form" method="post" action="<?php echo site_url('save_detail_ubah_zona_mpa');?>" enctype="multipart/form-data">
...
<div id="lima">
    <div>
      <?php foreach($detail as $jokowi){?>
        <form action="<?php echo site_url().'content_dashboard_mpa/c_content_dashboard_mpa/export_detail_utir'?>" method="post" enctype="multipart/form-data">
