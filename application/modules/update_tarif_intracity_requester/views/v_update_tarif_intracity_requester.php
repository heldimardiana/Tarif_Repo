...
<script type="text/javascript">
    $( function() {
        ...
        var data_peg = "<?php echo site_url().'update_tarif_intracity_requester/c_update_tarif_intracity_requester/get_origin_one';?>?cu=" + branch;
...
<script>
    function verify_yes_b(){
        ...
        if(parseInt(hasil) < parseInt(yes_a1) || parseInt(hasil) < parseInt(yes_a))
        {
...
<script>
    function verify_reg_b(){
        ...
        var reg_a    = $("#reg_a").val();
        var reg_a1   = $("#reg_a1").val();
        if(parseInt(hasil) < parseInt(reg_a) || parseInt(hasil) < parseInt(reg_a1))
        {
            alert("Zona B harus lebih besar dari Zona A or A1");
            var hasil = "";
        }
                        ...
                        <div class="col-md-4">                                      
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" class="form-control" required id="auto_ori" onkeyup="loadings()" maxlength="8">
