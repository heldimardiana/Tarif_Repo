...
class M_view_btbp extends CI_Model {
	...
	public function generate_btbp($origin)
	{
		$sql = "SELECT
...
/* End of file m_view_btbp.php */
/* Location: ./application/modules/view_btbp/models/m_view_btbp.php */