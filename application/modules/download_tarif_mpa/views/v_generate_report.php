...
<script type="text/javascript">
    $( function() {    
        var data_peg = "<?php echo site_url().'download_tarif_mpa/c_download_tarif_mpa/get_branch';?>";
...
<script type="text/javascript">
    function getOrigin(){
        ...
        var data_cab = "<?php echo site_url().'download_tarif_mpa/c_download_tarif_mpa/get_origin';?>?cu=" + branch;
        $( function() {
...
<script type="text/javascript">
    function getOrigin_after(){
        ...
        var data_cab = "<?php echo site_url().'download_tarif_mpa/c_download_tarif_mpa/get_origin_after';?>?cu=" + cabang_u;
        $( function() {
...
<script type="text/javascript">
    function getDestination(){
        ...
        var data_des = "<?php echo site_url().'download_tarif_mpa/c_download_tarif_mpa/get_destination';?>?cu=" + origin;
...
<script type="text/javascript">
    function getDestination_after(){
        ...
        var data_des = "<?php echo site_url().'download_tarif_mpa/c_download_tarif_mpa/get_destination_after';?>?cu=" + origin;
...
<script type="text/javascript">
    function getService(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('download_tarif_mpa/c_download_tarif_mpa/get_service_all')?>?dest="+gab,
            dataType: "json",
            data: ddest,
...
<script type="text/javascript">
    function getService_after(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('download_tarif_mpa/c_download_tarif_mpa/get_service_after')?>?dest="+gab,
            dataType: "json",
            data: ddest,
            success: function(data){
...
<div class="row">
    ...
    <div align="center">
      <button type="button" class="btn btn-info waves-effect waves-light">Live</button>
        ...
        <div class="card-box"> 
            <form action="<?php echo site_url('generate_tarif_mpa')?>" data-parsley-validate novalidate method="post">
                <div class="form-group">
                    <label for="emailAddress">Branch</label>
                    <input type="text" class="form-control" required id="auto_cu" onchange="getOrigin()">
                    <input type="hidden" class="form-control" name="branch" required id="branch">
                </div>
                <div class="form-group">
                    <label for="emailAddress">Origin</label>
                    <input type="text" class="form-control" required id="auto_ori" onkeypress="loading()" onchange="getDestination()">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" required  id="auto_des" onkeypress="loadings()" onchange="getService()">
    ...
    <div class="card-box"> 
      <form action="<?php echo site_url('generate_tarif_mpa_after')?>" data-parsley-validate novalidate method="post">
...
<div>
    <form action="<?php echo site_url().'download_tarif_mpa/c_download_tarif_mpa/export_to_excel'?>" method="post">
