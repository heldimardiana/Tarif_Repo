...
<script type="text/javascript">
    $( function() {    
        var data_peg = "<?php echo site_url().'live/c_live/get_branch_nas';?>";
...
<script type="text/javascript">
    function getOrigin(){
        ...
        var data_ori = "<?php echo site_url().'live/c_live/get_origin_nas';?>?branch=" + branch;
        $( function() {
...
<script type="text/javascript">
    function getDestination(){
        ...
        var data_des = "<?php echo site_url().'live/c_live/get_destination_nas';?>?cu=" + origin;
...
<script type="text/javascript">
    function getService(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('live/c_live/get_service_nas')?>?params="+gab,
            dataType: "json",
            data: ddest,
