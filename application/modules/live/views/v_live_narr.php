...
<script type="text/javascript">
    $( function() {    
        var data_peg = "<?php echo site_url().'live/c_live/get_cabang_utama_before_nar';?>";
...
<script type="text/javascript">
    function myFunction(){
        ...
        var data_cab = "<?php echo site_url().'live/c_live/get_cabang_before_nar';?>?cu=" + cabang_u;
        $( function() {
...
<script type="text/javascript">
    function destina(){
        ...
        var data_dest = "<?php echo site_url().'live/c_live/get_destination_before_nar';?>?cul=" + cabang;
        $( function() {
