...
<div class="row">
  <div class="col-sm-12">
    <div class="card-box">
      <div class="row">
        <form class="form-horizontal" role="form" method="post" action="<?php echo site_url('save_detail_update_tarif_intracity_mpa');?>" enctype="multipart/form-data">
            ...
            <div class="form-group" id="tut" style="display: none;">
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" class="form-control" id="tanggal" name="tgl_update_intracity" onkeyup="hapus()">
                </div>
            </div> 
            </div>
