			...
			<table id="mydata" class="table table-bordered table-hover table-responsive">
                ...
                <?php 
                   	...
                   	foreach ($uti as $ut){ 
                   		...
                   		$tgl_test = date('d-m-Y',strtotime($ut['TGL_UPDATE_INTRACITY']));
                ...
                <tr id="data_row_<?php echo$n; ?>">
	                ...
	                <td class="text-center">
	                	<a href="<?php echo site_url().'update_tarif_intracity_mpa/c_update_tarif_intracity_mpa/detail_update_tarif_intracity_mpa/'.$session ?>">
		        ...
		        <tr id="data_row_<?php echo$n; ?>">
	                ...
	                <?php $session = $ut['SESSION_REQUEST'] ?>
	                <td class="text-center">
	                	<a href="<?php echo site_url().'update_tarif_intracity_mpa/c_update_tarif_intracity_mpa/detail_testing_update_tarif_intracity_mpa/'.$session ?>">
	                		<button type="button" class="btn btn-primary btn-xs" title="Lihat Detail">Detail</button>
	                	</a>
	                </td>
		        </tr>
