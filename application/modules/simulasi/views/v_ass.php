...
<script type="text/javascript">
    $( function() {    
        var data_peg = "<?php echo site_url().'simulasi/c_simulasi/get_branch_ass';?>";
...
<script type="text/javascript">
    $( function() {    
        var data_peg = "<?php echo site_url().'simulasi/c_simulasi/get_branch_ass_after';?>";
...
<script type="text/javascript">
    function getOrigin(){
        ...
        var data_ori = "<?php echo site_url().'simulasi/c_simulasi/get_origin_ass';?>?branch=" + branch;
        $( function() {
...
<script type="text/javascript">
    function getOrigin_after(){
        ...
        var data_ori = "<?php echo site_url().'simulasi/c_simulasi/get_origin_ass_after';?>?branch=" + branch;
        $( function() {
...
<script type="text/javascript">
    function getDestination(){
        ...
        var data_des = "<?php echo site_url().'simulasi/c_simulasi/get_destination_ass';?>?cu=" + origin;
...
<script type="text/javascript">
    function getDestination_after(){
        ...
        var data_des = "<?php echo site_url().'simulasi/c_simulasi/get_destination_ass_after';?>?cu=" + origin;
...
<script type="text/javascript">
    function getService(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('simulasi/c_simulasi/get_service_ass')?>?params="+gab,
            dataType: "json",
            data: ddest,
...
<script type="text/javascript">
    function getService_after(){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('simulasi/c_simulasi/get_service_ass_after')?>?params="+gab,
            dataType: "json",
            data: ddest,
            success: function(data){
...
<div class="row">
	...
	<div class="col-lg-6">
        ...
        <img src="<?php echo base_url();?>assets/images/loading.gif" width="60" style="display:none;" id="gambars"></img>
				...
				<div class="form-group">
					...
					<input type="text" name="nick" parsley-trigger="change" required  class="form-control" id="auto_des" onkeypress="loading()" onchange="getService()" maxlength="8">
	...
	<div class="col-lg-6">
		...
		<div class="card-box">       
          ...
          <div class="col-lg-8">
            <label for="userName">Branch</label>
            <input type="text" name="nick" parsley-trigger="change" required  class="form-control" id="auto_br_a" onchange="getOrigin_after()" maxlength="6" onkeyup="heldi2();">
        ...
        <div class="form-group">
					<label for="userName">Branch</label>
					<input type="text" name="nick" parsley-trigger="change" required  class="form-control" id="auto_br_a" onchange="getOrigin_after()">
					<input type="hidden" name="nick" parsley-trigger="change" required  class="form-control" id="branch_after">
				</div>
        -->
				<div class="form-group">
					<label for="userName">Origin</label>
					<input type="text" name="nick" required  class="form-control" id="auto_or_a" onkeypress="load()" onchange="getDestination_after()" maxlength="8">
				...
				<div class="form-group">
					<label for="userName">Destination</label>
					<input type="text" name="nick" required  class="form-control" id="auto_des_a" onkeypress="loads()" onchange="getService_after()" maxlength="8">
				...
				<div class="form-group">
					<label for="userName">Service Active</label>
