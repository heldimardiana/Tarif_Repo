...
<div class="row">
	<div class="col-sm-12">
		<div class="card-box">
			<div class="row">
				<form class="form-horizontal" role="form" method="post" action="<?php echo site_url('save_btbp_level_3');?>" enctype="multipart/form-data">
					...
					<div class="col-md-5">    
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <select class="form-control" title="Pilih Status" required name="status" onChange="Getstatus(this);set_Required();">
                        ...
                        <div class="form-group" id="tut" style="display: none;">
                            ...
                            <div class="col-md-8">
                                ...
                                <input type="text" class="form-control" id="tanggal" name="tgl_update_btbp" onkeyup="hapus()">
                            </div>
                        </div>
					</div>
...
<div>
  <?php foreach($detail as $jokowi){?>
    <form action="<?php echo site_url().'update_btbp_mpa/c_update_btbp_mpa/export_detail_btbp'?>" method="post" enctype="multipart/form-data">
