                        ...
                        <div style="margin:0;">
                            ...
                            ?>
                              <tr>
                                ...
                                <td>
                                    <input type="number" min="0" class="form-control" name="bp_after_1st_kilo[]" id="bp_after_1st_kilo_<?php echo $n ?>" style="width:100px;" onchange="bp_after_1st(<?php echo $n ?>)" placeholder="BP 1st Kilo" required value="<?php echo $gt['LINEHAUL']?>"> 
                                    <!--required -->
                                </td>
                                <td>
                                ...
                                <td>
                                    <input type="number" min="0" class="form-control" name="bp_after_next_kilo[]" id="bp_after_next_kilo_<?php echo $n ?>" style="width:120px;" onchange="bp_after_next(<?php echo $n ?>)" placeholder="BP Next Kilo" required value="<?php echo $gt['LINEHAUL_NEXT']?>">
                                    <!--required -->
                                </td>
                                <td>
                                ...
                                <td>
                                    <input type="number" min="0" class="form-control" name="bt_after[]" id="bt_after_<?php echo $n ?>" style="width:100px;" onchange="bt_after(<?php echo $n ?>)" placeholder="BT" required value="<?php echo $gt['TRANSIT']?>"> <!--required -->
                                </td>
                                <td>
                                ...
                                <td>
                                    <input type="number" min="0" class="form-control" name="bd_oke_after[]" id="bd_oke_after_<?php echo $n ?>" style="width:100px;" onchange="oke_after(<?php echo $n ?>)" placeholder="BD Oke" required value="<?php echo $gt['DL_BEFORE_OKE']?>"> <!--required -->
                                </td>
                                <td>
                                ...
                                <td>
                                    <input type="number" min="0" class="form-control" name="bd_reg_after[]" id="bd_reg_after_<?php echo $n ?>" style="width:100px;" onchange="reg_after(<?php echo $n ?>)" placeholder="BD Reg" required value="<?php echo $gt['DL_BEFORE_REG']?>"> <!--required -->
                                </td>
                                <td>
                                ...
                                <td>
                                    <input type="number" min="0" class="form-control" name="bd_yes_after[]" id="bd_yes_after_<?php echo $n ?>" style="width:100px;" onchange="yes_after(<?php echo $n ?>)" placeholder="BD Yes" required value="<?php echo $gt['DL_BEFORE_YES']?>"> <!--required -->
                                </td>
                                <td>
                                ...
                                <td>
                                    <input type="number" min="0" class="form-control" name="bd_sps_1st_kilo_after[]" id="bd_sps_1st_kilo_after_<?php echo $n ?>" style="width:100px;" onchange="bd_sps_1st(<?php echo $n ?>)" placeholder="BD SPS 1st" required value="<?php echo $gt['DL_BEFORE_SPS']?>"> 
                                    <!--required -->
                                </td>
                                <td>
                                ...
                                <td>
                                    <input type="number" min="0" class="form-control" name="bd_sps_next_kilo_after[]" id="bd_sps_next_kilo_after_<?php echo $n ?>" style="width:120px;" onchange="bd_sps_next(<?php echo $n ?>)" placeholder="BD SPS Next" required value="<?php echo $gt['DL_BEFORE_NEXT_SPS']?>"> 
                                    <!--required -->
                                    <!--
                                    <input type="hidden" name="drourate_service[]" id="drourate_service" value="<?php echo $gt['DROURATE_SERVICE']?>">
                                    -->
                                    <input type="hidden" name="drourate_service[]" id="drourate_service" value="">
                                </td>
                              </tr>
                            <?php $n++; } ?>
                            </tbody>
