...
class M_download_tarif_requester extends CI_Model {
	...
	{
		$sql = "SELECT * FROM V_TARIF_DETAIL WHERE ROUTING = '".$this->db->escape($routing)."' 
				AND DROURATE_SERVICE = '".$this->db->escape($service)."'";
		$query = $this->db->GetArray($sql);
		return $query;
	}

	public function generate_tarif_all_after($routing,$service,$no_request)
	{
	...
	public function generate_tarif_all_afters($routing,$service,$no_request)
	{
...
/* End of file m_download_tarif_requester.php */
/* Location: ./application/modules/download_tarif_requester/models/m_download_tarif_requester.php */